...
public class GespannPlanungActivity extends AppCompatActivity {
    ...
    private void routeInMaps() {
        ...
        String adr_sra2;
        Spielort adr_ziel;
        adr_refStart = Objects.requireNonNull(refMap.get((String) startadresse.getSelectedItem().toString())).replace("#", ", ");
        adr_sra1 = Objects.requireNonNull(refMap.get((String) sra1.getSelectedItem().toString())).replace("#", ", ");
        adr_sra2 = Objects.requireNonNull(refMap.get((String) sra2.getSelectedItem().toString())).replace("#", ", ");
